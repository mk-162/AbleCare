...
const PROMO_RULES: PromoRule[] = [
  {
    ...
    body: "Standardise screening across every branch. Protect HHVBP scores and reduce hospitalisations with Able Assess.",
    ctaText: "Learn more",
    ctaLink: "/home-care",
    variant: "landing",
  },
  ...
  },
  {
    ...
    body: "Objective, repeatable falls risk data that flows straight into your quality programme.",
    ctaText: "Learn more",
  ...
  },
  {
    ...
    body: "See how falls prevention technology pays for itself through reduced hospitalisations and improved star ratings.",
