...
const GOOGLE_PLAY_PATH =
  "M3.18 23.76c.3.16.64.22.98.17l12.49-12.49L12.9 7.7 3.18 23.76zM.5 1.83C.19 2.2 0 2.74 0 3.46v17.08c0 .72.19 1.26.5 1.63l.08.08 9.57-9.57v-.22L.58 1.75.5 1.83zM20.65 10.6l-2.71-1.56-3.04 3.04 3.04 3.04 2.73-1.58c.78-.45.78-1.5-.02-1.94zM3.18.24L12.9 7.7l3.75-3.75c-.28-.16-.6-.19-.91-.07L3.18.24z";
