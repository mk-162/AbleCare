...
export function CtaBanner({
  ...
  return (
    <section className="relative overflow-hidden" style={{ backgroundColor: isBlue ? "#1432FF" : "#ffffff" }}>
      <div className="w-full leading-none" style={{ marginTop: "-2px" }} aria-hidden="true">
      ...
      {isBlue && (
        <>
          <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full opacity-20 pointer-events-none"
            style={{ background: "radial-gradient(circle at top right, #00FFD2, transparent 70%)" }} />
          <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full opacity-10 pointer-events-none"
            style={{ background: "radial-gradient(circle at bottom left, #ffffff, transparent 70%)" }} />
        </>
      )}
