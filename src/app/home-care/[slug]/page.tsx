...
export default async function HomeCareSubPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  ...
  try {
    ...
    console.error(`[home-care/[slug]] fetchPage failed for slug="${slug}"`, err);
    throw err;
  }
...
export async function generateStaticParams() {
  try {
    ...
    const homeCareSubSlugs = ["pe-backed", "independent"];
    return homeCareSubSlugs
