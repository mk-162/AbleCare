  ...
  fields: [
    ...
    { type: "string" as const, name: "heading", label: "Section Heading" },
    {
      ...
      fields: [
        ...
        { type: "string" as const, name: "description", label: "Description", ui: { component: "textarea" } },
        { type: "image" as const, name: "image", label: "Step Image (optional, shown above the number circle)" },
      ],
    },
    { type: "string" as const, name: "ctaText", label: "CTA Text" },
  ...
  fields: [
    ...
    { type: "string" as const, name: "heading", label: "Section Heading" },
    {
      ...
      fields: [
        ...
        { type: "image" as const, name: "image", label: "Metric Image (optional, shown above the metric name)" },
      ],
    },
  ],
};
